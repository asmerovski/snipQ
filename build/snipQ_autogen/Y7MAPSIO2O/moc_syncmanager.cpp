...
#include "../../../src/sync/syncmanager.h"
...
template <> constexpr inline auto SyncManager::qt_create_metaobjectdata<qt_meta_tag_ZN11SyncManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'syncFinished'
        QtMocHelpers::SignalData<void(bool)>(6, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Bool, 7 },
        }}),
    };
...
void SyncManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->syncProgress((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 2: _t->syncFinished((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 3: _t->syncFinished((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)()>(_a, &SyncManager::syncStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)(int , const QString & )>(_a, &SyncManager::syncProgress, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)(bool , const QString & )>(_a, &SyncManager::syncFinished, 2))
            return;
    }
}
...
// SIGNAL 1
void SyncManager::syncProgress(int _t1, const QString & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void SyncManager::syncFinished(bool _t1, const QString & _t2)
{
